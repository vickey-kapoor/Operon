...
| Execution | `src/operon/executor/browser_native.py`, `src/operon/executor/desktop.py`, `src/operon/executor/browserbase_native.py` | Browser, desktop, and Browserbase execution |
...
| Store | `src/operon/store/` | Run store, memory store, replay, summaries, cleanup |
