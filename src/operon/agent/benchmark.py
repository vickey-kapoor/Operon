...
from operon.agent.perception import GeminiPerceptionService
...
from operon.models.benchmark import (
    BenchmarkSuiteSpec,
...
from operon.store.summary import (
...
async def run_stress_benchmark(
    ...
    *,
    ...
    """
    from operon.api.benchmark_suite import StressRunner
    ...
    from operon.agent.loop import AgentLoop as _AgentLoop  # noqa: F401 — import check
