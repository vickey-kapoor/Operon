...
from operon.agent.policy import PolicyError, PolicyService, parse_policy_output
...
class CombinedPerceptionPolicyService(PerceptionService, PolicyService):
    ...
    def __init__(
        ...
        self.prompt_path = prompt_path or Path(__file__).resolve().parents[3] / "prompts" / "desktop_combined_prompt.txt"
