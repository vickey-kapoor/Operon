...
class StubRunStore:
    ...
    def create_run(self, intent: str, *, start_url: str | None = None, headless: bool | None = None, benchmark: str | None = None, mode: str = "batch") -> AgentState:
        self.state = AgentState(run_id="run-benchmark", intent=intent, start_url=start_url, benchmark=benchmark, mode=mode, status=RunStatus.PENDING)
        return self.state
